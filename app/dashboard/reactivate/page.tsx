      ...
      <div className="border border-white/10 p-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <button
            ...
            className="px-6 py-3 bg-white text-black font-medium text-sm uppercase tracking-wider hover:bg-white/95 transition disabled:opacity-50"
          >
          ...
          <button
            ...
            className="px-6 py-3 border border-white/20 text-white/80 text-sm uppercase tracking-wider hover:bg-white/5 transition"
          >
            No, sign me out
          </button>
        </div>
