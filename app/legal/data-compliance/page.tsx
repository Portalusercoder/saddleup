...
export default function DataCompliancePage() {
  ...
  return (
    <LegalPageShell
      ...
      arabicBody={
        <>
          <section><h2>1. الغرض من هذه الصفحة</h2><p>تعرض هذه الصفحة إطار الامتثال وحماية البيانات في المملكة بما يتماشى مع نظام PDPL.</p></section>
          <section><h2>2. الأدوار: متحكم ومعالج</h2><p>قد نكون متحكمًا لبيانات تشغيل المنصة، ومعالجًا لبيانات العملاء التشغيلية ضمن تعليماتهم.</p></section>
          <section><h2>3. مبادئ الامتثال</h2><ul><li>المشروعية والشفافية.</li><li>تحديد الغرض.</li><li>تقليل البيانات.</li><li>الدقة.</li><li>تحديد مدة الاحتفاظ.</li><li>الأمان.</li><li>المساءلة.</li></ul></section>
          <section><h2>4. السجلات وتقييمات الأثر</h2><p>نحتفظ بسجلات المعالجة والمزودين، وننفذ تقييمات أثر حماية البيانات عند الحاجة.</p></section>
          <section><h2>5. طلبات أصحاب البيانات</h2><p>يمكن تقديم طلبات الحقوق عبر <a href={`mailto:${contact}`}>{contact}</a>، وقد تتطلب بعض الطلبات تنسيقًا مع إدارة الإسطبل.</p></section>
          <section><h2>6. إدارة الحوادث</h2><p>نطبق إجراءات لاكتشاف الحوادث وتحليلها والحد من آثارها والإبلاغ عند وجوب ذلك نظامًا.</p></section>
          <section><h2>7. النقل عبر الحدود</h2><p>نقيّم عمليات النقل الدولي ونطبق الضمانات النظامية المناسبة.</p></section>
          <section><h2>8. المعالِجون الفرعيون</h2><p>قد تشمل الفئات: الاستضافة، المصادقة/البيانات، البريد، الدفع، والتحليلات وفق العقود والضوابط.</p></section>
          <section><h2>9. الاحتفاظ</h2><p>تختلف مدد الاحتفاظ حسب نوع البيانات والمتطلبات النظامية والتعاقدية.</p></section>
          <section><h2>10. الأمن السيبراني والتنظيمي</h2><p>نطبق ضوابط وصول، أقل صلاحية، إدارة أسرار، تحديثات دورية، ومراجعة مزودين.</p></section>
          <section><h2>11. التدريب</h2><p>يتلقى الأفراد ذوو الوصول للبيانات تدريبًا مناسبًا والتزامات سرية متناسبة مع أدوارهم.</p></section>
          <section><h2>12. التعاون التنظيمي</h2><p>نتعاون مع الجهات المختصة وفق الأنظمة مع تقليل الإفصاح لقدر الحاجة.</p></section>
          <section><h2>13. التواصل</h2><p>للاستفسارات: <a href={`mailto:${contact}`}>{contact}</a>.</p></section>
        </>
      }
    >
      <section>
